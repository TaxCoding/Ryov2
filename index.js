...
//=================================================//
CFonts.say("SC PAIRINK BY @zhaa.raja", {
   font: 'chrome',
  align: 'left',
...
vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await oka.getName(i + '@s.whatsapp.net')}\nFN:${await oka.getName(i + '@s.whatsapp.net')}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Ponsel\nitem2.EMAIL;type=INTERNET:rajanaufal8148@gmail.com\nitem2.X-ABLabel:Email\nitem3.URL:https://github.com/taxcoding\nitem3.X-ABLabel:Instagram\nitem4.ADR:;;Indonesia;;;;\nitem4.X-ABLabel:Region\nEND:VCARD`})}
//=================================================//
...
start(`1`,`Connecting...`)
  ...
  oka.sendMessage('6285745267782' + "@s.whatsapp.net", { text: `*Yogiri Versi 2*
  Telah Terhubung!!, Ketik .Menu untuk menampilkan command!
  
  *_Jangan Lupa Untuk Follow Ig Zhaa.raja Untuk Mendapatkan Info Terbaru._*
