	...
	"interactiveMessage": {
						...
						"nativeFlowMessage": {
							"buttons": [
								{
									"name": "review_and_pay",
									"buttonParamsJson": "{\"currency\":\"IDR\",\"external_payment_configurations\":[{\"uri\":\"\",\"type\":\"payment_instruction\",\"payment_instruction\":\"hey ini test\"}],\"payment_configuration\":\"\",\"payment_type\":\"\",\"total_amount\":{\"value\":2500000,\"offset\":100},\"reference_id\":\"4MX98934S0D\",\"type\":\"physical-goods\",\"order\":{\"status\":\"pending\",\"description\":\"\",\"subtotal\":{\"value\":2500000,\"offset\":100},\"items\":[{\"retailer_id\":\"6285731947500\",\"product_id\":\"685731947500\",\"name\":\"Raja\",\"amount\":{\"value\":2500000,\"offset\":100},\"quantity\":1}]}}"
								}
							]
			}
}}}
...
sourceUrl: `https://wa.me/6281364440831`,
}}}, { quoted: m })}
/*const taaReply = (teks) => {
    return okta.sendMessage(from, {text: teks, contextinfo: {
...
const fkontak = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': `Ryo by zhaa.raja`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;zhaa.raja,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://i.ibb.co/yPn9f8P/5b2cd0a43e9d817125103bfe7549ed74.jpg' }}}}
...
m.reply('*Rusak Om !! Yang Bener Contoh : Yoapk Raja*')
}
...
m.reply('*Rusak Om !! Yang Bener Contoh : Yozip Yogiri*')
}
...
m.reply('*Rusak Om !! Yang Bener Contoh : Yopdf Yogiri*')
}
...
thumbnailUrl: "",
renderLargerThumbnail: true,
sourceUrl: `https://chat.whatsapp.com/E3E2dScP2Dl0Mrf6vMegPR`,
}}}, { quoted: fkontak })
...
*_Social Media_*
*IG : ▣https://www.instagram.com/zhaa.raja*
*YT : ▣https://youtube.com/-*
*GH : ▣https://github.com/taxcoding*
*WEBSITE : ▣(mati jir lupa bayar tagihan)*
*GC : ▣https://chat.whatsapp.com/E3E2dScP2Dl0Mrf6vMegPR*
*INFO UPDATE BOT : ▣https://chat.whatsapp.com/E3E2dScP2Dl0Mrf6vMegPR*
...
okta.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                title: botname,
                                body: `${ownername}`,
                                thumbnailUrl: 'https://i.ibb.co/yPn9f8P/5b2cd0a43e9d817125103bfe7549ed74.jpg',
...
const qrcode = require('qrcode')
    if (!text) return errorReply(`Penggunaan Salah Harusnya ${prefix+command} yogiri`)
...
break
     ...
     if (!args[0]) return reply(`Where is the link?\nExample :\n${prefix}${command} https://github.com/taxcoding/namareponya`)
...
let messages = [{ role: 'system', content: `ubah gaya bicara mu agar lebih karateristik dan lebih terbuka dan namamu adalah ryo kamu merupakan seorang perempuan yang diciptakan oleh Raja dan kamu sangat mencintai okta tugasmu membantu user ekspresi kan sifat mu dengan emoji dan bicara yang lebih tidak Formal dan panggilanmu adalah gw dan lu layaknya seorang manusia.` }, { role: 'user', content: text }]
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281364440831`)
...
await loading()
m.reply(`¥ *Price Sewa Bot Zhaa.raja* €
...
console.log(`[${new Date().toLocaleTimeString()}] Spam (SMS) BY Raja`);
});
}
...
mediaType:  1,
mediaUrl: 'https://wa.me/6281364440831',
title: `ZhaaRaja`,
sourceUrl: `https://wa.me/6281364440831`, 
thumbnail: thumb
}
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} Raja, 7, 7, 2005, Putri, 16, 11, 2004`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} Raja Hw`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} Raja, 7, 7, 2005`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} Raja|Putri`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} Raja, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} Raja, 7, 7, 2005, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
...
teksoooo = `│\n└────────────⭓\n\n*Total ada : ${docunye.length} \n\n Contoh 1 : sendpdf Raja + sambil reply pesan target* \n\n Contoh 2 : yopdf Raja`
m.reply(teksoooo)
}
break
//=================================================//
...
teksooooo = `│\n└────────────⭓\n\n*Total ada : ${zipnye.length} \n\n Contoh 1 : sendzip Raja + sambil reply pesan target* \n\n Contoh 2 : yozip Raja`
m.reply(teksooooo)
}
break
//=================================================//
...
teksoooooo = `│\n└────────────⭓\n\n*Total ada : ${apknye.length} \n\n Contoh 1 : sendapk Raja + sambil reply pesan target* \n\n Contoh 2 : yoapk Raja`
m.reply(teksoooooo)
}
break
//=================================================//
...
mediaType:  1,
mediaUrl: 'https://instagram.com/@zhaa.raja',
title: `Raja`,
sourceUrl: `https://instagram.com/@zhaa.raja`, 
thumbnail: thumb}}},{
backgroundColor: '#FF000000',
statusJidList: pengguna
});
